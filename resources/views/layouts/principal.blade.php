  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navPrincipal">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('listar-produto') ? 'active' : '' }}" href="{{ route('listar-produto') }}">Lista de produtos</a></li>
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('cadastro-produto') ? 'active' : '' }}" href="{{ route('cadastro-produto') }}">Cadastrar produto</a></li>
