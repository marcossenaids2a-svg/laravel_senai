  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item"><a class="nav-link active" href="{{ route('servicos') }}">Serviços</a></li>
...
<main class="container py-5">
  ...
  <div class="row g-4">
    <div class="col-12 col-md-4"><div class="card service-card text-center p-4"><h4>Troca de Óleo</h4><p>Serviço rapido para sua moto.</p><button class="btn btn-danger btn-servico" data-servico="Troca de oleo">Agendar</button></div></div>
    <div class="col-12 col-md-4"><div class="card service-card text-center p-4"><h4>Revisão completa</h4><p>Deixe sua moto segura para rodar.</p><button class="btn btn-danger btn-servico" data-servico="Revisao completa">Agendar</button></div></div>
    <div class="col-12 col-md-4"><div class="card service-card text-center p-4"><h4>Troca de pneus</h4><p>Pneus novos com instalação.</p><button class="btn btn-danger btn-servico" data-servico="Troca de pneus">Agendar</button></div></div>
    ...
    <div class="col-12 col-md-4"><div class="card service-card text-center p-4"><h4>Diagnóstico eletronico</h4><p>Descubra problemas na hora.</p><button class="btn btn-danger btn-servico" data-servico="Diagnostico eletronico">Agendar</button></div></div>
  </div>
</main>
